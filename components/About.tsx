...
import profile from "../public/1604.jpeg"
            ...
            <div
                ...
                <div className="lg:px-4 lg:mt-12 ">
                    ...
                    <div className="mt-6 text-gray-800 dark:text-white">
                        ...
                        <p className="mb-4">Welcome to my digital garden, where I share what I'm learning about shipping
                            great products, becoming a better developer and growing a career in tech.
                        </p>
                        <h2 className="font-bold">Let’s Make the Web. Faster 🚀</h2>
                    </div>
                </div>
                    ...
                    <div className="flex justify-center mt-6">
                        <div
                            ...
                            <a className="transition-colors hover:text-sky-500" target="_blank" rel="noreferrer"
                               href="https://twitter.com/Aslamraisani55">
                            ...
                            <a className="transition-colors hover:text-sky-500" target="_blank" rel="noreferrer"
                               href="https://www.linkedin.com/in/aslamraisani">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512"
                                     className="text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a className="transition-colors hover:text-sky-500" target="_blank" rel="noreferrer"
                               href="https://github.com/aslamkhan5">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 496 512"
                                   ...
                                   href="https://www.thefullstackdeveloper.com">
                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512"
                                 className="text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                <path
